...
public class Average {
	 ...
	 */
	public static double findAverage(Conteiner array) throws NullArrayException {
	 ...
	 * @throws NullArrayException
	 */
	public static double findGeometricAverage(Conteiner array) throws NullArrayException {
		if (array != null && array.getArray().length != 0) {
