...
/**
 * The program sorts an array in the ascending order with using bubble sorting.
 * 
 * @author Alena Shirokikh
 * @version 1.0 1.11.2018
 */
import by.epam.javatraining.alenashirokikh.tasks.maintask01.main.model.logic.BubbleSortAscending;
...
public class BubbleSortAscendingView {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		double[] array = UserInput.readArrayWithSize("Enter the array");
		array = BubbleSortAscending.doBubbleSort(array);
		String result = "";
